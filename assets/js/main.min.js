...
(function() {
  var aside = document.querySelector('.block-left');
  var mainContainer = document.querySelectorAll('.block-right');
  var switcher = document.getElementById('switch-arrow');

  if(switcher) switcher.addEventListener('click', slide, false);

  function slide() {

    if(aside.classList.contains('aside-left')) {
    	aside.classList.remove('aside-left');
    	aside.classList.remove('opaque');
    	setTimeout(function() {
    		aside.classList.remove('hide-contents');
    	}, 500);
    }
    else {
    	aside.classList.add('aside-left');
      aside.classList.add('hide-contents');
    	setTimeout(function() {
        aside.classList.add('opaque');       
    	}, 500);
    }
